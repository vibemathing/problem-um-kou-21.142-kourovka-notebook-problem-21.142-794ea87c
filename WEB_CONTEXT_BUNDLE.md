...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.142"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c-v1",
      "problem_contract_sha256": "3ba2107af152f756e19e6ea73169073a9881187c09fb660d01b5da633419ee75",
      "problem_id": "problem:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c",
      "route_id": "route:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c-source-fidelity-01",
      "graph_id": "graph:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "A group $G$ is said to be invariably generated by $a$ and $b$ if $G$ is generated by the conjugates $a^g,b^h$ for every $g,h$. Let $p\\ne q$ be fixed primes. Does every finite group embed into a finite group invariably generated by an element of order $p$ and an element of order $q$?"
          },
          "statement_sha256": "87ad9dc1e30b303acd6d36f5548e996d2546c84094cfa44ad12a178309c729ac"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c-root",
      "route_id": "route:um-kou-21.142-kourovka-notebook-problem-21.142-794ea87c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.142-8e2840097e0d",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.142"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
